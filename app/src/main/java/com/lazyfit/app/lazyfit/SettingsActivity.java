    ...
    private void retrieveUserInfo(){
        RootRef.child("Users").child(currentUserID)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if((dataSnapshot.exists()) && dataSnapshot.hasChild("name") && dataSnapshot.hasChild("profile image")){
                            setUserName = dataSnapshot.child("name").getValue().toString();
                            String retrieveUserAboutMe = dataSnapshot.child("aboutMe").getValue().toString();
                            String retrieveUserProfileImage = dataSnapshot.child("profile image").getValue().toString();
